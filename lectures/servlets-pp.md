...
See [Creating a REST Request for Yahoo! Search Web Services](http://developer.yahoo.net/search/rest.html) for more information.  Again, though, REST is just a way to think about access dynamic data from the web.
